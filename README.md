...
<script type="text/javascript">
  ...
  g.async = true;
  g.defer = true;
  g.src = 'https://cdn.jsdelivr.net/npm/erdbox@1.6.1/dist/erdbox.js';
  window.document.body.appendChild(g);
</script>
```

**Note: replace `1.6.1` in the above code with the latest version of erdbox. This can always be found by visiting the erdbox package page at [https://www.npmjs.com/package/erdbox](https://www.npmjs.com/package/erdbox)**
